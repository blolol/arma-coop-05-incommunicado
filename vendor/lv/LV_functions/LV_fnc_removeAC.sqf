...
//Syntax: nul = [handle,style,syncedUnit,range/delay,flee direction] execVM "vendor\lv\LV_functions\LV_fnc_removeAC.sqf";
//*handle = the name of ambientCombat, ex: war = [this] execVM "vendor\lv\ambientCombat.sqf"; <-war is the handle
...
LV_deleteOnDestination = compile preprocessFile "vendor\lv\LV_functions\LV_fnc_deleteOnDestination.sqf";
LV_killAfterDelay = compile preprocessFile "vendor\lv\LV_functions\LV_fnc_killAfterDelay.sqf";
