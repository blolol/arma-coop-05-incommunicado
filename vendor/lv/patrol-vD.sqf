...
//*Syntax: nul = [this] execVM "vendor\lv\patrol-vD.sqf";
//     or: nul = [this,center position,radius,handle doors] execVM "vendor\lv\patrol-vD.sqf";
...
if(isNil("LV_CloseDoors"))then{LV_CloseDoors = compile preprocessFile "vendor\lv\LV_functions\LV_fnc_closeDoors.sqf";};
